...
public final class MangaSettingsManager {
    ...
    public static String getReaderUi(Context context) { String value = context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getString(KEY_READER_UI, READER_UI_DEFAULT); if (READER_UI_V2.equals(value) || READER_UI_V1.equals(value) || READER_UI_DEFAULT.equals(value)) return value; return READER_UI_DEFAULT; }
    ...
    public static boolean isReaderZoomEnabled(Context context) { return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_READER_ZOOM, false); }
    ...
    public static void normalizeReaderChapterPreloadModes(Context context) {
        ...
        boolean inline = prefs.getBoolean(KEY_READER_INLINE_CHAPTER_PRELOAD, false);
    ...
    public static boolean isReaderInlineChapterPreloadEnabled(Context context) { normalizeReaderChapterPreloadModes(context); return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_READER_INLINE_CHAPTER_PRELOAD, false); }
    ...
    public static boolean isAutoSaveFavoriteHistoryImagesEnabled(Context context) { return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_AUTO_SAVE_FAVORITE_HISTORY_IMAGES, false); }
    ...
    public static boolean isHideLatestChapterLabelEnabled(Context context) { return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_HIDE_LATEST_CHAPTER_LABEL, false); }
    ...
    public static boolean isHideTypeLabelEnabled(Context context) { return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_HIDE_TYPE_LABEL, false); }
    ...
    public static boolean isBoldMangaTitleEnabled(Context context) { return context.getSharedPreferences(PREFS, Context.MODE_PRIVATE).getBoolean(KEY_BOLD_MANGA_TITLE, false); }
